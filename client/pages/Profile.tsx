            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="flex items-center pl-4 gap-2 text-sm font-medium text-foreground mb-2">
                    ...
                    <input
                      ...
                      value={editData.nis}
                      onChange={handleInputChange}
                      className="w-full pl-4 px-4 py-2 border border-border rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-primary/50"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full pl-10 px-4 py-2 border border-border rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-primary/50"
                    />
                  </div>
                  <div>
                    <label className="flex items-center gap-2 text-sm font-medium text-foreground mb-2">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  <p className="flex items-center gap-2 text-foreground/70">
                    <img src="https://cdn-icons-png.flaticon.com/512/732/732200.png" className="w-3.5 h-3.5 filter hue-rotate-180 contrast-125" alt="Email" />
                    Email
                  </p>
                ...
                <div>
                  <p className="flex items-center gap-2 text-foreground/70">
                    <img src="https://cdn-icons-png.flaticon.com/512/8074/8074788.png" className="w-3.5 h-3.5 filter hue-rotate-180 contrast-125" alt="School" />
                    Sekolah
                  </p>
                  <p className="font-semibold text-foreground">
                    {profile.school}

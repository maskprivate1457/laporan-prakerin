              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-foreground mb-2">
                      <img
                        src="https://tse1.mm.bing.net/th?q=nis+icon+logo&w=32&h=32&c=7&rs=1&p=0&dpr=2"
                        alt="NIS Icon"
                        className="w-4 h-4 object-contain animate-pulse brightness-110 drop-shadow-[0_0_3px_rgba(57,255,20,0.5)]"
                      />
                      <span>NIS</span>
                    </label>
                    <input
